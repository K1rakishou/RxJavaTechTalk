...
class `09_nested_rx_streams_error_handling` {
    ...
    /**
     * Зачем создавать вложенные стримы?
     ...
     * и передать в стрим несколько onError или onComplete, но это нарушение контракта, а при
     * нарушении контракта пропадают гарантии).
     * */
    @Test
