...
class `12_schedulers` {
     ...
     * был вызван.
     * SubscribeOn кидает таску на экзекутор в subscribeActual, observeOn в onNext
     * */
     ...
     * Подходит для тяжёлых задач, которые активно юзают CPU.
     *
     ...
     * выполняется на одном и том же потоке. Потому что стрим создаётся один раз и
