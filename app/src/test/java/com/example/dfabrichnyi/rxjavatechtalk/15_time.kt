...
class `15_time` {
    ...
    /**
     * Ждёт заданное вреям, затем эмитит обзёрвабл содержащий 0L. С помощью оператора timeInterval
    ...
    /**
     * Эмитит обзёрвабл через равные промежутки времени. Горячий обзёрвабл по-умолчанию. Будет
     * эмитить даже если на него никто не подписан.
     * */
    @Test
    fun testInterval() {
