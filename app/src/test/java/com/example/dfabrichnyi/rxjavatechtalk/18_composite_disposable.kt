...
class `18_composite_disposable` {
     ...
     * если после этого добавить новый disposable, то стрим с которым он ассоциирован будет работать
     *
     * Dispose отписывается от каждого сохранённого disposable и очищает свой внутренний список,
     * если после этого добавить новый disposable, CompositeDisposable его не только не добавит,
